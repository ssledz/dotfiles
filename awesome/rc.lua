...
-- {{{ Tags
tags = {
   names = { "web", "term", "ide",  "docs", "media", "6", "7", "8", "9" },
   layout = { layouts[1], layouts[3], layouts[1], layouts[4], layouts[1], layouts[2], layouts[2] , layouts[2], layouts[2]}
}
