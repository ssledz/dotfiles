...
(custom-set-variables
 ...
 '(company-backends
   '(company-bbdb company-semantic company-cmake company-capf company-clang company-etags company-files
 ...
 '(package-selected-packages
   '(magit psci racket-mode expand-region multiple-cursors company solarized-theme gnu-elpa-keyring-update xcscope window-number undo-tree merlin haskell-mode drag-stuff company-coq auto-complete))
